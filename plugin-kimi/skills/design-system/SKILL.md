...
> Detail (format `design-system.md`, elicit token+motion, atom dispatch + wadah app-local/package, gate, CAPTURE, scope N-design-system, persist mockup) ada di `${KIMI_SKILL_DIR}/../../skills/design-system/reference.md` — baca itu dulu.
