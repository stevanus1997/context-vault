...
- **Risiko** — Apa yang bisa bikin gagal (pasar jenuh, switching cost tinggi, regulasi, beratnya eksekusi)? **Compliance (durable, carve-out ke `risks.md`):** nilai terstruktur kewajiban regulasi — **PCI** (kartu/bayar) · **GDPR/privasi** (data pribadi) · **pajak** (jurisdiksi/PPN) · **KYC/AML** (identitas) + regulasi sektor/jurisdiksi spesifik. Lihat `${KIMI_SKILL_DIR}/../../rules/compliance-risk.md`.
