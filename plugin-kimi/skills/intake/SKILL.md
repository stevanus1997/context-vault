...
Q&A ikuti `${KIMI_SKILL_DIR}/../../rules/elicitation.md` (keputusan-bercabang satu per giliran, opsi bawa konsekuensi). Tanya level bisnis: siapa penggunanya, **alur yang dilewati pengguna (happy-path) + minimal 1 skenario edge/gagal**, aturan/kebijakan, hasil yang diharapkan, batasan. JANGAN tanya hal teknis (framework, DB, dll) — itu jatah skill `plan`.
