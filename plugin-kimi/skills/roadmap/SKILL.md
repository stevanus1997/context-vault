...
> Q&A ikuti `${KIMI_SKILL_DIR}/../../rules/elicitation.md` (keputusan-bercabang satu per giliran, opsi bawa konsekuensi). Status fitur TIDAK pernah ditulis ke `roadmap.md` — selalu diturunkan dari `control/features/*/feature.yaml` saat dibaca (nol dual-write).
